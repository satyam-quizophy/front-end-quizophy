...
const CATEGORY_URL = window.location.host==="localhost:3011"?"http://localhost:5000/api/common/courseCategory" :'https://quiz.quizophy.com/api/common/courseCategory'
