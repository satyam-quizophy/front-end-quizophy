...
import {createQuiz, getAllTemplates} from '../quizList/core/_requests'
...
const Create: FC = () => {
  ...
  const [questions, setQuestions] = useState<Array<any>>([question])
  ...
  const [templateModal, showTemplateModal] = useState(true)
